...
Para exibir uma imagem customizada no diagrama da home, colocar o arquivo em `assets/images/` com um dos nomes reconhecidos: `image.png`, `infographic.png`, `processo.png`, `diagrama.png` (e variantes `.jpg`/`.webp`). O fallback é um SVG inline.
